            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item active" href="9.php">Set checker 9</a></li>
...
<div class="container my-5">
    ...
    <div class="col-lg-8 px-0">
        <p>Enter the cards currently on your table to check if there is a set (assumes there are 9 cards on your table).</p>
